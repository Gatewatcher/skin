...
import type { ReducerAction } from './FormStore';
...
export type FieldsErrors = Record<string, Meta['errors']>;
...
export type InternalValidateFields<Values = unknown> = (
  nameList?: NamePath[],
  options?: ValidateOptions,
) => Promise<Values>;

export type ValidateFields<Values = unknown> = (
  nameList?: NamePath[],
) => Promise<Values>;
...
export interface Callbacks<Values = any> {
  onValuesChange?: (changedValues: unknown, values: Values) => void;
...
export interface FormInstance<Values = any> {
  ...
  setErrors: (error: FieldsErrors, options?: SetErrorsOptions) => void;
